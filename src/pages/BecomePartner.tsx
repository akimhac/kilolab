...
import { 
  ...
  CheckCircle, Loader2, Shield, Euro, Users, Zap
} from 'lucide-react';
...
export default function BecomePartner() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Créer le partenaire (inactif par défaut, en attente de validation)
  ...
  const benefits = [
    { icon: Euro, title: "0€ d'inscription", desc: "Gratuit pour toujours" },
    { icon: Shield, title: "0€ d'abonnement", desc: "Aucun frais fixe" },
    { icon: CheckCircle, title: "0 engagement", desc: "Partez quand vous voulez" }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Devenez partenaire<br />Kilolab
            </h1>
            
            <p className="text-xl text-white/90 mb-8">
              Inscription 100% gratuite • Validation sous 24h
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span>+2600 pressings déjà partenaires</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span>Commission de seulement 10%</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span>Nouveaux clients chaque jour</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span>Dashboard de gestion inclus</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              <p className="italic text-white/90 mb-4">
                "Depuis que j'ai rejoint Kilolab, j'ai 30% de clients en plus. 
                Le système est simple et je garde 90% de chaque commande."
              </p>
              <p className="font-semibold">— Marie D., Pressing Le Propre, Lyon</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl">
            ...
            <p className="text-slate-600 mb-6">
              Remplissez le formulaire, on vous valide sous 24h
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
