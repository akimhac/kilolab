  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Akim.hachili@gmail.com"
                required
        ...
        {/* Section développeur - visible uniquement en mode dev */}
        {import.meta.env.DEV && (
          <div className="mt-4 bg-slate-800/50 rounded-lg p-4 text-xs">
            <p className="text-slate-400 font-semibold mb-2">🔧 Mode développeur</p>
