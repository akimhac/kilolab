  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 flex items-center justify-center px-4">
      <div className="max-w-4xl w-full">
        <button 
          onClick={() => navigate('/')} 
          className="mb-8 flex items-center gap-2 text-gray-600 hover:text-teal-600 transition-colors"
        >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Je veux faire laver mon linge
              </p>
              <div className="mt-6 px-6 py-2 bg-blue-600 text-white rounded-lg font-medium group-hover:bg-blue-700 transition-colors">
                Se connecter
              </div>
            </div>
          </button>
          ...
          {/* ESPACE WASHER */}
          <button 
            onClick={() => navigate('/login?type=washer')} 
            className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-teal-600 group relative overflow-hidden"
          >
            {/* Badge "Nouveau" */}
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Espace Washer</h2>
              <p className="text-gray-600 text-sm mb-4">
                Je veux gagner de l'argent en lavant du linge
              </p>
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600">
            ...
            <button 
              onClick={() => navigate('/select-signup')} 
              className="text-teal-600 font-medium hover:text-teal-700 underline decoration-2"
            >
              S'inscrire
            </button>
          </p>
        ...
        {/* Lien discret vers Pressing (legacy) */}
        <div className="text-center mt-6">
          <button 
            onClick={() => navigate('/login?type=partner')}
            className="text-xs text-gray-400 hover:text-gray-600 underline"
          >
            Vous êtes un pressing pro ? Accès legacy ici
          </button>
        </div>
      </div>
    </div>
