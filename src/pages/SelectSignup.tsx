    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 flex items-center justify-center px-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Créer un compte Kilolab</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <button onClick={() => navigate('/signup')} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-teal-600 group">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Compte Client</h2>
              <p className="text-gray-600 text-sm mb-4">Commandez en quelques clics</p>
              <div className="mt-6 px-6 py-2 bg-teal-600 text-white rounded-lg font-medium group-hover:bg-teal-700 transition-colors">
                S'inscrire
              </div>
            </div>
          </button>
          <button onClick={() => navigate('/become-partner')} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-teal-600 group">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-teal-600 transition-colors">
                <Store className="w-8 h-8 text-teal-600 group-hover:text-white transition-colors" />
              </div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Compte Pressing Partenaire</h2>
              <p className="text-gray-600 text-sm mb-4">Rejoignez notre réseau</p>
              <div className="mt-6 px-6 py-2 bg-teal-600 text-white rounded-lg font-medium group-hover:bg-teal-700 transition-colors">
                Devenir partenaire
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600">
            ...
            <button onClick={() => navigate('/select-dashboard')} className="text-teal-600 font-medium hover:text-teal-700 underline decoration-2">
              Se connecter
            </button>
          </p>
        </div>
