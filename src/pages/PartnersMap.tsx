        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 rounded-2xl border-2 border-blue-300 focus:border-blue-600 focus:outline-none text-lg"
            />
            <Navigation className="absolute right-4 top-1/2 -translate-y-1/2 w-6 h-6 text-blue-600" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {selectedPartner ? (
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <h1 className="text-4xl font-black bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-6">
            ...
            <button
              ...
              className="w-full py-5 rounded-2xl font-bold text-xl text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:shadow-2xl transition-all transform hover:scale-105"
            >
              Créer ma commande
            </button>
          </div>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                          ...
                          <button
                            ...
                            className="px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold hover:shadow-lg transition text-sm"
                          >
                            Commander
                          </button>
                        </div>
