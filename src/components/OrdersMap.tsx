...
import { Package, MapPin, Navigation, Euro } from 'lucide-react';
...
// Custom marker icons
const createOrderIcon = (formula: string) => {
  ...
  return (
    <div className="relative h-full rounded-2xl overflow-hidden border border-white/10">
              ...
              <div className="p-3 min-w-[200px]">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                  ...
                  <span className="font-bold text-teal-600">
                    {(parseFloat(String(order.total_price)) * 0.6).toFixed(2)} €
                  </span>
                </div>
                <button
      ...
      <div className="absolute bottom-4 left-4 bg-slate-900/90 backdrop-blur-sm rounded-xl p-3 border border-white/10 z-[1000]">
        <p className="text-xs text-white/60 font-bold mb-2">Légende</p>
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <span className="text-white/80">Éco</span>
          </div>
        </div>
      </div>
