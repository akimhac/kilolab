...
echo "🔧 FIX CARTE - ENLEVER FILTRE is_active"
echo "========================================"
...
echo "✅ PartnersMap.tsx mis à jour (filtre is_active enlevé)"

npm run build

if [ $? -eq 0 ]; then
  git add src/pages/PartnersMap.tsx
  git commit -m "fix: enlever filtre is_active sur carte partners"
  git push origin main
  
  echo ""
  echo "🎉 PUSHÉ ! Dans 2 minutes teste:"
  echo "   https://kilolab.fr/partners-map"
  echo ""
  echo "Tu devrais voir TES 2678 PRESSINGS ! 🗺️"
fi
