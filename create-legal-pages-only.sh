...
echo "📄 Création des pages légales uniquement"
echo ""
...
echo "📝 2/3 - Création Mentions Légales..."
...
echo "📝 3/3 - Création Politique de Confidentialité..."
...
echo ""
echo "✅ Pages légales créées avec succès !"
echo ""
echo "📁 Fichiers créés:"
...
echo ""
echo "1. Mettez à jour App.tsx - Ajoutez ces imports:"
echo "   import CGU from './pages/legal/CGU';"
echo "   import MentionsLegales from './pages/legal/MentionsLegales';"
echo "   import Privacy from './pages/legal/Privacy';"
echo ""
echo "2. Ajoutez ces routes dans <Routes>:"
echo "   <Route path=\"/legal/cgu\" element={<CGU />} />"
echo "   <Route path=\"/legal/mentions-legales\" element={<MentionsLegales />} />"
echo "   <Route path=\"/legal/privacy\" element={<Privacy />} />"
echo ""
echo "3. Mettez à jour le footer dans LandingPage.tsx - Section Légal:"
echo "   <button onClick={() => navigate('/legal/cgu')}>CGU</button>"
echo "   <button onClick={() => navigate('/legal/privacy')}>Confidentialité</button>"
echo "   <button onClick={() => navigate('/legal/mentions-legales')}>Mentions légales</button>"
echo ""
echo "4. Committez:"
echo "   git add src/pages/legal/"
echo "   git commit -m 'feat: add legal pages (CGU, Privacy, Mentions legales)'"
echo "   git push"
ENDOFFILE
