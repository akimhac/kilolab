...
## Sprint 20 - Abonnement + Smart Assignment + Dual Role + Bugfix (05-06/04/2026)
...
- [x] Navbar role-aware (Mes missions vs Mes commandes, fidélité conditionnelle)
- [x] Tests: iterations 21-25 - 100% pass
...
- [x] Landing, i18n, BecomeWasher, Heatmap, B2B, Admin, PWA, GPS, PhotoCapture, Rating, Invoice
