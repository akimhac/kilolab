...
echo "🚀 Création de la nouvelle landing page inspirée de Laundryheap..."
...
echo "✅ Landing page créée !"
echo ""
echo "Maintenant:"
echo "git add src/pages/LandingPage.tsx"
echo "git commit -m 'feat: new landing page inspired by Laundryheap'"
echo "git push"
ENDOFFILE
